...
namespace VHierarchy
{
    class VHierarchyMenu
    {
        ...
        public static bool componentCustomButtonGaspar { get => EditorPrefs.GetBool("vHierarchy-componentButtonGasparEnabled", false); set => EditorPrefs.SetBool("vHierarchy-componentButtonGasparEnabled", value); }
        ...
        const string gasparButtonMinimap = dir + "Component GasparButton";
        ...
        [MenuItem(gasparButtonMinimap, false, 2)] static void buttonCustomGasparClicked() { componentCustomButtonGaspar = !componentCustomButtonGaspar; EditorApplication.RepaintHierarchyWindow(); }
        [MenuItem(gasparButtonMinimap, true, 2)] static bool buttonGasparChecked() { Menu.SetChecked(gasparButtonMinimap, componentCustomButtonGaspar); return !pluginDisabled; }
